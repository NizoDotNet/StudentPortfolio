    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LabWorksId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<string>(type: "varchar(255)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserLabWork", x => new { x.LabWorksId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_AppUserLabWork_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserLabWork_LabWorks_LabWorksId",
                        column: x => x.LabWorksId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserLabWork_UsersId",
                table: "AppUserLabWork",
                column: "UsersId");
